...
pEl2.textContent =
  "Indie pop that has no shortage of melodies, led by A.C. Newman who is the chief songwriter, It is a supergroup of Canadian indie musicians. Notably Neko Case, Dan Bejar, and keyboardist Kristen Dahle. Alt-country legend Case uses her voice in a more pop style, which is both pleasing, and melodic. Destroyer' Dan Bejar sings a few tracks and writes some songs as well. The band is very tight musically and playful at the same time. Without taking from their influences too much. Having been playing music since 2000 on their first long player Mass Romantic which features one of my favorite songs. Letter From an Occupant, which features lead vocals from Neko Case, is an indie pop classic. The guitars are sharp with out being overpowering of the more subtle elements of the track, the beat is a total bop.";
